<#
Run on Primary DC. Sets up its static IP and hostname
#>
#-------------
#- Variables -                                         
#-------------
...
# Network Variables
$ethalias = 'Ethernet0'
$ethipaddress = '192.168.179.150' #11.11.11.5
$ethprefixlength = '24'
$ethdefaultgw = '192.168.179.1' #11.11.11.1
$ethdns = '192.168.179.1,8.8.8.8' # for multiple DNS you can append DNS entries with comma's

# Remote Desktop Variable
$enablerdp = 'no' # to enable RDP, set this variable to yes. to disable RDP, set this variable to no
